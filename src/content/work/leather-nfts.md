...
<figure>
  <video src="/videos/work/leather-nfts/cross-platform-activity.mp4" aria-label="Demo: shared feature packages running identically on Leather mobile and the browser extension" autoplay loop muted playsinline preload="metadata"></video>
...
<figure>
  <video src="/videos/work/leather-nfts/collectibles-mobile.mp4" aria-label="Demo: the collectibles gallery on Leather mobile" autoplay loop muted playsinline preload="metadata"></video>
  <figcaption>The collectibles gallery on mobile — Stacks SIP-9 and Bitcoin Ordinals in one unified view.</figcaption>
</figure>

<figure>
  <video src="/videos/work/leather-nfts/collectibles-extension.mp4" aria-label="Demo: the collectibles gallery on the Leather browser extension" autoplay loop muted playsinline preload="metadata"></video>
