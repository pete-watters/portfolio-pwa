...
Working on the Cockpit was a good counterpoint to Coderunner. On Coderunner I'd taken over and rebuilt the frontend, owning that layer end to end. Cockpit was an established, complex application where my contributions needed to fit into existing patterns and work alongside other engineers' code. Both required different skills -- one rewarded architectural thinking, the other rewarded precision and attention to integration detail.
