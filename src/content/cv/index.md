...
### [Xapo](https://www.xapo.com) · Senior Frontend Engineer
...
### [Bank of America Merrill Lynch](https://www.bankofamerica.com) · Senior Frontend Engineer
...
Awarded a master's scholarship for academic performance and completed it remotely while working full-time. My thesis focused on research into academic performance analysis, and I developed a Java web application using HighCharts and the Google Visualisation API to model performance data. [Read thesis](/docs/thesis-pete-watters.pdf)
